...
RSpec.describe SugoiLogWatcher::Aggregater do
  let(:single_log) do
    <<~EOH
      ...
      I, [2017-12-26T00:01:53.205907 #36002]  INFO -- :   Rendered welcome/_cambanner.html.haml (3.0ms)
      ...
      I, [2017-12-26T00:01:57.403712 #36002]  INFO -- :   Rendered shared/_ehim.haml (3.1ms)
      ...
      I, [2017-12-26T00:01:58.283101 #36002]  INFO -- :   Rendered layouts/_html.haml (3.7ms)
